...
cp -rf $work_dir/bin/modfile/Appmod/gallery/MIUIGallery/* $work_dir/build/baserom/images/product/priv-app/MIUIGallery
cp -rf $work_dir/bin/modfile/Appmod/gallery/permissions/privapp_whitelist_com.miui.gallery.xml $work_dir/build/baserom/images/product/etc/permissions/
