...
title HyperOS Flash ROM - Update (Keep Data)
cd %~dp0
set fastboot=META-INF\fastboot
set /p DeviceCodeRom=<META-INF\Data\DeviceCode

echo =======================================================
echo         HyperOS Custom ROM - Update (Keep Data)
echo =======================================================
echo.
...
echo.
echo =======================================================
echo Your device will be updated.
echo Your apps, settings, and files will NOT be formatted.
echo =======================================================
...
echo Now wait for 5-10 minutes for booting.
echo ##############################################################
echo.
